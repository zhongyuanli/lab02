...
### Output:
Graded at: 2020-11-04 02:09:38.674874
```
...
Two servers, ten concurrent transactions (2 points): failed (too few transactions in output)
Five servers, continuous transactions (3 points): failed (too few transactions in output)
One of two servers fail (1 point): failed (too few transactions in output)
Three of six servers fail (2 points): failed (too few transactions in output)
FINAL SCORE: 2/10
```